...
function MapsSelector({selectMap, ...props}:Props) {
    ...
    return (
        <section className={'grid content-center w-full bg-mainBg min-h-[100vh] py-10 bg-cover bg-no-repeat overflow-x-hidden hide-scrollbars-keep-functionality'} style={{backgroundImage:`url(${mapPreview})`}}>
            <div className={'relative bg-secondaryBg bg-opacity-60 mb-[25vh] pt-[2rem] sm:pt-[3rem] md:pt-[5rem] lg:pt-[9rem]'}>
                <h1 className={'text-3xl sm:text-4xl md:text-6xl lg:text-9xl animate-grow logo font-bold text-highlightText text-center absolute left-1/2 -translate-x-1/2 w-full top-0 select-none'}>Where is Waldo?</h1>
